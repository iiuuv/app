...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='/app/my_project/converted_model_modified2.bin', 
                        help="""Path to BPU Quantized *.bin Model.
                                ...
                                RDK S100: Nash-e.
                                RDK S100P: Nash-m.""")
    parser.add_argument('--test-img', type=str, default='/app/my_project/v8seg-photo/IMG_20250603_154302.jpg', help='Path to Load Test Image.')
    parser.add_argument('--img-save-path', type=str, default='/app/my_project/v8seg-photo/result.jpg', help='Path to save result image.')
    parser.add_argument('--classes-num', type=int, default=12, help='Classes Num to Detect.')
...
coco_names = ["background","person","knife","fork","cup","giraffe","plate","table","cake","fence","hat","terrain"]
