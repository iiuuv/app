...
def main():
    ...
    parser.add_argument('--test-img', type=str, default='/app/my_project/photo/IMG_20250630_180720_5.jpg', help='Path to Load Test Image.')

    parser.add_argument('--img-save-path', type=str, default='/app/result.jpg', help='Path to Load Test Image.')
    ...
    parser.add_argument('--score-thres', type=float, default=0.75, help='confidence threshold.')
