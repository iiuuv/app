...
def main_fire():
    ...
    parser.add_argument('--model-path', type=str, default='/app/my_project/666/yolo11_fire.bin', 
    ...
    while True:
        ...
        # Forward
        # 准备输入数据
        input_tensor = model.preprocess_yuv420sp(resized_data)
        # 推理
        ...
        for class_id, score, x1, y1, x2, y2 in results:
            ...
            packet1 = bytes([0x54,
                        0x01,x11,x12%256,y11,y12%256,
                        0x02,x21,x22%256,y11,y12%256,
                        0x03,x11,x12%256,y21,y22%256,
                        0x04,x21,x22%256,y21,y22%256,
                        0x45])
            if class_id==0:
                for i in range(10):
                    ser.write(packet1)
                
            # packet2 = bytes([0x54,0xFF,0x45])
        ...
        send_img(client_socket, resized_data, 1)
...
coco_names = ["fire","smoke"]

rdk_colors1 = [
    (56, 56, 255), (151, 157, 255), (31, 112, 255), (29, 178, 255),(49, 210, 207), (10, 249, 72), (23, 204, 146), (134, 219, 61),
    (52, 147, 26), (187, 212, 0), (168, 153, 44), (255, 194, 0),(147, 69, 52), (255, 115, 100), (236, 24, 0), (255, 56, 132),
    (133, 0, 82), (255, 56, 203), (200, 149, 255), (199, 55, 255)]
rdk_colors = [(199, 55, 255),(236, 24, 0)]
